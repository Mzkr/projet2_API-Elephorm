package com.example.alexis.projet2_elephorm.util;
...
/**
 * Created by Damien on 02/09/15.
 */
    public class ProxyParseObject implements Serializable {
        ...
        public ProxyParseObject(ParseObject object) {
            ...
            for(String key : object.keySet()) {
                ...
                if(classType == byte[].class || classType == String.class ||
                    ...
                    ProxyParseObject parseUserObject = new ProxyParseObject((ParseObject)object.get(key));
        ...
        public ProxyParseObject getParseUser(String key) {
            if(has(key)) {
                return (ProxyParseObject) values.get(key);
            } else {
                return null;
            }
        }
